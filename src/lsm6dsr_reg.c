...
int32_t lsm6dsr_pin_int1_route_set(stmdev_ctx_t *ctx, lsm6dsr_pin_int1_route_t *val)
{
    ...
    if (ret == 0) {
        if ((val->emb_func_int1.int1_fsm_lc | val->emb_func_int1.int1_sig_mot | val->emb_func_int1.int1_step_detector |
             ...
             val->fsm_int1_a.int1_fsm7 | val->fsm_int1_a.int1_fsm8 | val->fsm_int1_b.int1_fsm9 | val->fsm_int1_b.int1_fsm10 |
             val->fsm_int1_b.int1_fsm11 | val->fsm_int1_b.int1_fsm12 | val->fsm_int1_b.int1_fsm13 |
             val->fsm_int1_b.int1_fsm14 | val->fsm_int1_b.int1_fsm15 | val->fsm_int1_b.int1_fsm16) != PROPERTY_DISABLE) {
...
int32_t lsm6dsr_pin_int2_route_set(stmdev_ctx_t *ctx, lsm6dsr_pin_int2_route_t *val)
{
    ...
    if (ret == 0) {
        if ((val->emb_func_int2.int2_step_detector | val->emb_func_int2.int2_tilt | val->emb_func_int2.int2_sig_mot |
             ...
             val->fsm_int2_a.int2_fsm7 | val->fsm_int2_a.int2_fsm8 | val->fsm_int2_b.int2_fsm9 | val->fsm_int2_b.int2_fsm10 |
             val->fsm_int2_b.int2_fsm11 | val->fsm_int2_b.int2_fsm12 | val->fsm_int2_b.int2_fsm13 |
             val->fsm_int2_b.int2_fsm14 | val->fsm_int2_b.int2_fsm15 | val->fsm_int2_b.int2_fsm16) != PROPERTY_DISABLE) {
